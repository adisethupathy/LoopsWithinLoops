...
def run_test_sum_numbers():
    ...
    # Test 3:
    expected = 38
    answer = sum_numbers([(4, 2, 0), (3, 10), [7, 8, 3, 1]])
    print('Expected and actual are:', expected, answer)

    # Test 4:
    expected = 74
    answer = sum_numbers([(3, 2, 2), (8, 31), [1, 9, 9, 9]])
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = 65
    answer = sum_numbers([(8, 1, 12), (20, 2), [1, 9, 6, 6]])
    print('Expected and actual are:', expected, answer)
